<div class="buttons-social-media-share">
    <ul class="share-buttons">
        ...
        <li>
            <a href="https://twitter.com/intent/tweet?url={{ request()->fullUrl() }}&text={{ $description }}&via=&hashtags=BlogIngeniero"
        ...
        <li><a href="https://pinterest.com/pin/create/bookmarklet/?url={{ request()->fullUrl() }}&description={{ $description }}"
